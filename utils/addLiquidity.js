...
export const calculateCD = async (
  ...
  // The ratio we follow is (amount of Musto Dev tokens to be added) / (Musto Dev tokens balance) = (Eth that would be added) / (Eth reserve in the contract)
  // So by maths we get (amount of Musto Dev tokens to be added) = (Eth that would be added * Musto Dev tokens balance) / (Eth reserve in the contract)

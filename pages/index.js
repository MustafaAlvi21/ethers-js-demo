...
export default function Home() {
  ...
  // `reservedCD` keeps track of the Musto Dev tokens Reserve balance in the Exchange contract
  ...
  /**
   * swapTokens: Swaps  `swapAmountWei` of Eth/Musto Dev tokens with `tokenToBeReceivedAfterSwap` amount of Eth/Musto Dev tokens.
   */
  ...
  /**
   * _getAmountOfTokensReceivedFromSwap:  Returns the number of Eth/Musto Dev tokens that can be received 
   * when the user swaps `_swapAmountWEI` amount of Eth/Musto Dev tokens.
   */
   ...
   * then we calculate the Musto dev tokens he can add, given the Eth he wants to add by keeping the ratios
   * constant
   */
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Musto Dev Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} Musto Dev LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`You will need ${utils.formatEther(addCDTokens)} Musto Dev Tokens`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  Add
                </button>
            ...
            <div>
              ...
              <div className={styles.inputDiv}>
                {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                {`You will get ${utils.formatEther(removeCD)} Musto Dev Tokens and ${utils.formatEther(removeEther)} Eth`}
              </div>
  ...
  return (
    <div>
      <Head>
        <title>Musto Devs</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Musto Devs Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Musto Dev Tokens
          </div>
          <div>
            <button
